...
export const DataAbilities : { [key:string]: Ability } = {
    ...
    guard: AT.guard({ name: 'Guard' }, {}),
    hot: AT.addAbility({ name: 'HOT', cost: 2 }, { count : 1, range : 5, duration: 2, abilityName : 'regeneration' }),
    buffSpeed: AT.tempEffect({ name: 'Buff Movement', cost: 1 }, { range : 5, effect : { movement: 5 }, duration: 1 }),
    ...
    autoHitForest: AT.tempEffectOnAttackByTerrain({ name: 'Buff Attack' }, { effect : { meleeAttack: 100 }, terrainType: TerrainType.Forest }),
